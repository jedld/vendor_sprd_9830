...
struct lsc2_tune_param{
	...
	// alsc2_param
	float lambda_r;        // need to add lambda_r , lambda_b and change type to unsigned int
	float lambda_b;        // need to add lambda_r , lambda_b and change type to unsigned int
	float weight_r;	 // need to add weight_r , weight_b and change type to unsigned int
	float weight_b;	 // need to add weight_r , weight_b and change type to unsigned int
};
...
struct lsc_adv_calc_param{
	...
	uint32_t flash_mode;                // 0. no flash  ,  1. during flash
