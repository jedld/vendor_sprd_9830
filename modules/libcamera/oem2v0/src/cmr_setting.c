				                   ...
				                   struct setting_cmd_parameter *parm)
{
	...
	struct setting_general_item   general_list[] = {
		...
		{SETTING_GENERAL_3A_LOCK_UNLOCK, &hal_param->is_3a_lock, COM_ISP_SET_3A_LOCK_UNLOCK},
	};
			                ...
			                struct setting_cmd_parameter * parm)
{
	...
	static struct setting_item     setting_list[] = {
		...
		{CAMERA_PARAM_ISP_3A_LOCK_UNLOCK, setting_set_3a_lock_unlock},
		{CAMERA_PARAM_AE_METERING_AREA,        setting_set_ae_metering_area},
