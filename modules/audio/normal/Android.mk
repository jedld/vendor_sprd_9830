...
## prebuilt HuaweiApkAudioTest.a for 32 bit ARM arch
ifeq ($(strip $(TARGET_ARCH)), arm)
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := HuaWeiLaoHua/HuaweiApkAudioTest.a
include $(BUILD_MULTI_PREBUILT)
endif

## prebuilt HuaweiApkAudioTest.a for 64 bit ARM arch
ifeq ($(strip $(TARGET_ARCH)), arm64)
include $(CLEAR_VARS)
LOCAL_MODULE := HuaWeiLaoHua/HuaweiApkAudioTest.a
LOCAL_MODULE_CLASS := STATIC_LIBRARIES
LOCAL_MULTILIB := 32
LOCAL_MODULE_STEM_32 := HuaWeiLaoHua/HuaweiApkAudioTest.a
LOCAL_SRC_FILES_32 := HuaWeiLaoHua/HuaweiApkAudioTest.a
